...
def remove_direct_inference(puzzle : Sudoku) -> Sudoku:
    '''
...
def remove_box_inference(puzzle : Sudoku) -> Sudoku:
    '''
...
def remove_row_inference(puzzle : Sudoku) -> Sudoku:
    '''
    Method to remove cells in the puzzle which can be inferred by looking at options for each empty
...
def remove_column_inference(puzzle : Sudoku) -> Sudoku:
    '''
    Method to remove cells in the puzzle which can be inferred by looking at options for each empty
